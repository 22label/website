...
/**
 * Home-only bottom-right social dock (Figma 289-1213). The three social icons that
 * used to live in the top-right menu now sit in the bottom-right corner of the MUSIC
 * homepage — anchored 64px from the right + bottom edges (--corner-gap), the same
 * corner the release previewer used (which is hidden on Home). Desktop-only and
 * Home-only, so other Music routes keep their existing top-right social untouched.
 *
...
export default function HomeSocialDock() {
  // Home only — other Music routes keep their existing top-right social.
